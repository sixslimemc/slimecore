...
execute store result score *x _slimecore summon text_display run function slimecore:_/impl/eval/pack/main
...
scoreboard players reset *pack.dep_err _slimecore
