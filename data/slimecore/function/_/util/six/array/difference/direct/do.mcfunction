...
data modify storage slimecore:_ util.difference.var.a_items set from storage slimecore:_ util.difference.in.a
data modify storage slimecore:_ util.difference.var.b_items set from storage slimecore:_ util.difference.in.b
...
data merge storage slimecore:_ {util:{difference:{var:{direct_unique:[]}}}}
data modify storage slimecore:_ util.difference.var.a_items set from storage slimecore:_ util.difference.in.b
data modify storage slimecore:_ util.difference.var.b_items set from storage slimecore:_ util.difference.in.a
execute if data storage slimecore:_ util.difference.var.a_items[0] run function slimecore:_/util/six/array/difference/direct/each
