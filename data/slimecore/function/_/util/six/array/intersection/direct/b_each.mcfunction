...
data modify storage slimecore:_ util.intersection.var.b_item set from storage slimecore:_ util.intersection.in.b_iter[-1]
...
data remove storage slimecore:_ util.intersection.in.b_iter[-1]
execute if data storage slimecore:_ util.intersection.in.b_iter[0] run function slimecore:_/util/six/array/intersection/direct/b_each