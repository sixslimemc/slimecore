...
data modify storage slimecore:_ util.intersection.var.b_item set from storage slimecore:_ util.intersection.in.b[-1]
...
data remove storage slimecore:_ util.intersection.in.b[-1]
