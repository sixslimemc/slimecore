...
$execute if data storage slimecore:_ t.load{tag_key:"entrypoint"} run data modify storage slimecore:hook entrypoint set value {preload_entrypoint:{pack_ref:"$(pack_ref)", id:"$(id)"}}
