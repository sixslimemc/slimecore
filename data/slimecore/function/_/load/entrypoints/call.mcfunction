...
$execute if data storage slimecore:_ t.load{tag_key:"entrypoint"} run data modify storage slimecore:hook entrypoint set value {entrypoint:{pack_ref:"$(pack_ref)", id:"$(id)"}}
...
$execute if data storage slimecore:_ t.load{tag_key:"preload_entrypoint"} run data modify storage slimecore:hook preload_entrypoint set value {preload_entrypoint:{pack_ref:"$(pack_ref)", id:"$(id)"}}
