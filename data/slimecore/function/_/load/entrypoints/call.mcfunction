...
execute if data storage slimecore:_ t.load{tag_key:"entrypoint"} run function #slimecore:hook/meta_info/call/entrypoint
...
execute if data storage slimecore:_ t.load{tag_key:"preload_entrypoint"} run function #slimecore:hook/meta_info/call/preload_entrypoint
