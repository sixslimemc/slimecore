...
$execute store success score *build.dupe_has_entry _slimecore run data modify storage slimecore:_ var.build.dupe_entry set from storage slimecore:_ var.build.error.duplicates[{pack:'$(pack)'}]
