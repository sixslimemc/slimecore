...
data modify storage slimecore:_ build.evalroot set from storage slimecore:_ build.depstack[-1].deps[-1]
function slimecore:_/build/second_pass/eval

data remove storage slimecore:_ build.depstack[-1].deps[-1]
