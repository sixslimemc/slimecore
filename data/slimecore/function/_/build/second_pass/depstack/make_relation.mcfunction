...
# a -> b
execute store result score *build.rel.r _slimecore run data get storage slimecore:_ build.make_relation.direction
$data modify storage slimecore:_ build.rel.this_r set from storage slimecore:_ build.rel.a.$(orderset)[{pack:'$(b)'}]
execute store result score *build.rel.er _slimecore run data get storage slimecore:_ build.rel.this_r.direction
execute store success score *build.rel.fail _slimecore if data storage slimecore:_ build.rel.this_r unless score *build.rel.r _slimecore matches 0 unless score *build.rel.r _slimecore = *build.rel.er _slimecore

$execute if score *build.rel.fail _slimecore matches 1.. run data modify storage slimecore:_ build.errors.relations.$(orderset) append value {a:'$(a)', b:'$(b)'}
...
$execute if score *build.rel.should_add _slimecore matches 1.. run data modify storage slimecore:_ build.rel.a.$(orderset) append value {pack:'$(b)', direction:0}
$execute if score *build.rel.should_add _slimecore matches 1.. store result storage slimecore:_ build.rel.a.$(orderset)[-1].direction int 1 run scoreboard players get *build.rel.r _slimecore

data remove storage slimecore:_ build.rel.this_r
...
$data modify storage slimecore:_ build.rel.this_r set from storage slimecore:_ build.rel.b.$(orderset)[{pack:'$(a)'}]
execute store result score *build.rel.er _slimecore run data get storage slimecore:_ build.rel.this_r.direction
execute store success score *build.rel.fail _slimecore if data storage slimecore:_ build.rel.this_r unless score *build.rel.r _slimecore matches 0 unless score *build.rel.r _slimecore = *build.rel.er _slimecore
