...
$execute store success score *build.has_error_entry _slimecore run data modify storage slimecore:_ var.build.dupe_entry set from storage slimecore:_ var.build.error.duplicate_packs[{pack:'$(pack)'}]
