...
data modify storage slimecore:data slimecore set value {pack_id:"slimecore", author_id:"sixslime", dependencies:[], contract_declarations:[], contracts_satisfied:[], entrypoints:[], preload_entrypoints:[], is_library:false, display:{name:"SlimeCore", author_name:"SixSlime", summary:"The SlimeCore datapack loader.", links:{author:"https://github.com/sixslimemc", info:"https://github.com/sixslimemc/slimecore_docs", versions:"https://github.com/sixslimemc/slimecore/releases"}}, url:"https://github.com/sixslimemc/slimecore/releases/download/v0.3.0/sixslime.slimecore.0.3.0.zip", version:{major:0, minor:3, patch:0}, loader_version:{major:0, minor:3}}
