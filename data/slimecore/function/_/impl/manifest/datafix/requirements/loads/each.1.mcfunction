#> slimecore:_/impl/manifest/datafix/requirements/loads/each.1

# order:
$execute unless data storage slimecore:_ impl.manifest.datafix.this_req.order.'$(this_load)' run data merge storage slimecore:_ {impl:{manifest:{datafix:{this_req:{order:{'$(this_load)':1b}}}}}}
