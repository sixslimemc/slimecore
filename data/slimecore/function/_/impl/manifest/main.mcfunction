...
# invalid:
data modify storage slimecore:_ manifests.invalid append value {}
data modify storage slimecore:_ manifests.invalid[-1].input set from storage slimecore:in manifest
