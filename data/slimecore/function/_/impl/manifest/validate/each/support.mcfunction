#> slimecore:_/impl/manifest/validate/each/support
#--------------------
# ../do
#--------------------
...
function slimecore:_/impl/manifest/validate/each/support.1 with storage slimecore:_ impl.manifest.macro

scoreboard players add *i _slimecore 1
data remove storage slimecore:_ impl.mainfest.validate.each.supports[-1]
execute if data storage slimecore:_ impl.mainfest.validate.each.supports[0] run function slimecore:_/impl/manifest/validate/each/support