#> slimecore:_/impl/manifest/dupe_deps/do
#--------------------
# ../main
#--------------------
...
data modify storage slimecore:_ impl.manifest.dupes.deps set from storage slimecore:_ impl.manifest.in.dependencies
data modify storage slimecore:_ impl.manifest.dupes.deps append from storage slimecore:_ impl.manifest.in.supports[]
