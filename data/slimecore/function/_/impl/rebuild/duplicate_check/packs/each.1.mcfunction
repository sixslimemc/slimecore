...
execute if data storage slimecore:_ v.rebuild.seen_duplicate run return run function slimecore:_/impl/rebuild/duplicate_check/packs/duplicate_id with storage slimecore:_ v.rebuild.this_pack
