...
$execute if data storage slimecore:_ v.rebuild.disable_entry run data modify storage slimecore:_ v.rebuild.disable_entry.path set from storage slimecore:_ v.rebuild.path_map.'$(pack_ref)'
...
$execute if data storage slimecore:_ v.rebuild.uninstall_entry run data modify storage slimecore:_ v.rebuild.uninstall_entry.path set from storage slimecore:_ v.rebuild.path_map.'$(pack_ref)'
