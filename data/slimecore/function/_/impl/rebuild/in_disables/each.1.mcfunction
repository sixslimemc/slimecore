...
data modify storage slimecore:_ v.rebuild.partial_pack.version set from storage slimecore:_ v.rebuild.disable_pack.version
...
$execute if data storage slimecore:data world.disabled_packs[{pack_id:"$(pack_ref)"}] run data modify storage slimecore:_ x.entry.call_tag set value false
