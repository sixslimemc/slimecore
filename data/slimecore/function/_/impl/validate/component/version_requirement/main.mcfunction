...
execute if score *x _slimecore matches 0 run data modify storage slimecore:out version_requirement.error.invalid_data append value {key:'major', expected:'positive int'}
...
execute store result score *x _slimecore run function slimecore:validate/component/int
execute if score *x _slimecore matches 0 run data modify storage slimecore:out version_requirement.error.invalid_data append value {key:'minor', expected:'positive int'}
...
execute unless score *x _slimecore matches 0.. run data modify storage slimecore:out version_requirement.error.invalid_data append value {key:'major', expected: 'positive int'}
...
execute unless score *x _slimecore matches 0.. run data modify storage slimecore:out version_requirement.error.invalid_data append value {key:'minor', expected: 'positive int'}
