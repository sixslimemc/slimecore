...
data modify storage slimecore:_ v.version_requirement.missings set from storage slimecore:out version_requirement.error.missing_data
data modify storage slimecore:_ v.version_requirement.invalids set from storage slimecore:out version_requirement.error.invalid_data
...
execute if data storage slimecore:_ v.version_requirement.missings[0] run function slimecore:_/impl/evaluate/component/pack_requirement/each_missing

data merge storage slimecore:_ {v:{pack_requirement:{mline:{1:'data modify storage slimecore:out version_requirement.error.invalid_data[-1].key set value "version.', 2:true, 3:'"'}}}}
execute if data storage slimecore:_ v.version_requirement.invalids[0] run function slimecore:_/impl/evaluate/component/pack_requirement/each_invalid
...
data modify storage slimecore:_ v.version_requirement.missings set from storage slimecore:out load_ordering.error.missing_data
data modify storage slimecore:_ v.version_requirement.invalids set from storage slimecore:out load_ordering.error.invalid_data
