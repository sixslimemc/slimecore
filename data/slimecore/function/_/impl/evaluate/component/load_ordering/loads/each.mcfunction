...
execute if score *x _slimecore matches -1 run data modify storage slimecore:out load_ordering.error.missing_data append value {key:''}
execute if score *x _slimecore matches -1 run data modify storage slimecore:out load_ordering.error.missing_data[-1].key set from storage slimecore:_ v.load_ordering.this_load
...
execute if score *x _slimecore matches -2 run data modify storage slimecore:out load_ordering.error.invalid_data[-1].key set from storage slimecore:_ v.load_ordering.this_load
