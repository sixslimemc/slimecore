#> slimecore:_/impl/evaluate/manifest/dupes/do.impls
#--------------------
# ../main
#--------------------
...
execute if data storage slimecore:_ impl.manifest.datafix.provisions.in[0] run function slimecore:_/impl/evaluate/manifest/datafix/provisions/each
