#> slimecore:_/impl/evaluate/manifest/dupes/each
#--------------------
# ./do
#--------------------
...
execute store result score *x _slimecore run function slimecore:_/impl/evaluate/manifest/dupes/check_seen with storage slimecore:_ impl.manifest.dupes.this_entry
...
execute if data storage slimecore:_ impl.manifest.dupes.entries[0] run function slimecore:_/impl/evaluate/manifest/dupes/each