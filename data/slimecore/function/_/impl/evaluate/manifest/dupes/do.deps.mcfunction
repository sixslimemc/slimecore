#> slimecore:_/impl/evaluate/manifest/dupes/do.deps
#--------------------
# ../main
#--------------------
...
data modify storage slimecore:_ impl.manifest.dupes.entries append from storage slimecore:_ impl.manifest.in.dependencies[]
