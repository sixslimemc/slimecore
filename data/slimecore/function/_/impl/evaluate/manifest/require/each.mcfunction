#> slimecore:_/impl/evaluate/manifest/require/each
#--------------------
# ./do
#--------------------
...
function slimecore:_/impl/evaluate/manifest/require/each.1 with storage slimecore:_ impl.manifest.macro
