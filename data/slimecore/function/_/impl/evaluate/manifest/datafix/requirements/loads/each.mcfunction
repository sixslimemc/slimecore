#> slimecore:_/impl/evaluate/manifest/datafix/requirements/loads/each
#--------------------
# ../do
#--------------------
...
function slimecore:_/impl/evaluate/manifest/datafix/requirements/loads/each.1 with storage slimecore:_ impl.manifest.datafix
