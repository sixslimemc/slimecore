#> slimecore:_/impl/evaluate/manifest/validate/each/implement
#--------------------
# ../do
#--------------------
...
function slimecore:_/impl/evaluate/manifest/validate/each/implement.1 with storage slimecore:_ impl.manifest.macro

scoreboard players add *i _slimecore 1
data remove storage slimecore:_ impl.mainfest.validate.each.implements[-1]
execute if data storage slimecore:_ impl.mainfest.validate.each.implements[0] run function slimecore:_/impl/evaluate/manifest/validate/each/implement