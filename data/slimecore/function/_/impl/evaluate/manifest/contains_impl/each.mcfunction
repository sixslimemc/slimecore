#> slimecore:_/impl/evaluate/manifest/contains_impl/each
#--------------------
# ../main
#--------------------
...
execute store success score *x _slimecore run function slimecore:_/impl/evaluate/manifest/contains_impl/check_contains with storage slimecore:_ impl.manifest.contains.this_impl
...
execute if data storage slimecore:_ impl.manifest.contains.impls[0] run function slimecore:_/impl/evaluate/manifest/contains_impl/each