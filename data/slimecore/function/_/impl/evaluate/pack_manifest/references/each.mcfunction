...
execute store result score *x _slimecore run function slimecore:evaluate/component/pack_reference

# success:
execute if score *x _slimecore matches 1 run function slimecore:_/impl/evaluate/pack_manifest/references/success

# error:
execute if score *x _slimecore matches 0 run function slimecore:_/impl/evaluate/pack_manifest/references/error
