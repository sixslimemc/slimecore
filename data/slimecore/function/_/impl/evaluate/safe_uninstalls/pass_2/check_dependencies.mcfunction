...
$data modify storage slimecore:_ util.to_packrefs.in.packs append from storage slimecore:_ v.safe_uninstalls.current_packs[{dependencies:[{pack:'$(this_un)'}]}].pack
