...
data remove storage slimecore:_ impl.safe_uninstalls.needed_impls
data modify storage slimecore:_ impl.safe_uninstalls.needed_impls set from storage slimecore:_ util.intersection.out.shared

execute unless data storage slimecore:_ impl.safe_uninstalls.needed_impls[] run return 1
