...
$data modify storage slimecore:_ v.safe_uninstalls.implements set from storage slimecore:in safe_uninstalls.build.auxilary.pack_map.'$(this_un)'.implements
...
$data modify storage slimecore:_ v.safe_uninstalls.unsafe_entry set from storage slimecore:out safe_uninstalls.unsafe[{pack:'$(this_un)'}]
$data remove storage slimecore:out safe_uninstalls.unsafe[{pack:'$(this_un)'}]
data modify storage slimecore:_ v.safe_uninstalls.unsafe_entry.pack set from storage slimecore:_ v.safe_uninstalls.this_un
