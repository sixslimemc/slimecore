...
execute unless score *safe_uninstalls.unsafe _slimecore matches 1 run data modify storage slimecore:out safe_uninstalls.safe[-1].pack set from storage slimecore:_ impl.safe_uninstalls.this_un
