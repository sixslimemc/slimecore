...
function slimecore:_/impl/evaluate/safe_uninstalls/pass_2/check_dependencies with storage slimecore:_ v.safe_uninstalls.valid_uninstalls[0]
function slimecore:_/impl/evaluate/safe_uninstalls/pass_2/check_implements with storage slimecore:_ v.safe_uninstalls.valid_uninstalls[0]
