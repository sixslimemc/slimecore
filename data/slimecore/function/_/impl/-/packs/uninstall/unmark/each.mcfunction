...
data modify storage slimecore:_ v.unmark.this_pack set from storage slimecore:_ v.unmark.input.packs[-1]

function slimecore:_/impl/-/packs/uninstall/unmark/remove with storage slimecore:_ v.unmark

data remove storage slimecore:_ v.unmark.input.packs[-1]
