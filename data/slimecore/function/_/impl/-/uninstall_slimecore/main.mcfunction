...
data modify storage slimecore:_ v.uninstall.msg append value {text:"\n", color:light_purple, extra:[{text:"Uninstalling SlimeCore will disable all SlimeCore-loaded datapacks. All SlimeCore-loaded datapacks will not be functional until SlimeCore is re-installed, and will then need to be manually re-enabled via '/datapack' to properly function again."}]}
data modify storage slimecore:_ v.uninstall.msg append value {text:"\n", color:green, bold:true, extra:[{text:"Are you sure you want to uninstall SlimeCore?"}]}
data modify storage slimecore:_ v.uninstall.msg append value {text:"\n", color:gold, extra:[{text:"[Click to confirm uninstallation]", hover_event:{action:"show_text", value:{text:"Uninstall SlimeCore", bold:true, color:gold}}, click_event:{action:"run_command", command:"function slimecore:_/impl/-/uninstall_slimecore/trigger"}}]}
