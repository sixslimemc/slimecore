...
tellraw @s {text:"", color:yellow, extra:[{text:"The easiest way to remedy this issue is to rename the SlimeCore datapack (within your world's "}, {text:"/datapacks", color:gray}, {text:" directory) to \""}, {text:"slimecore", color:gray}, {text:"\" or \""}, {text:"sixslime.slimecore", color:gray}, {text:"\"."}]}
