...
data modify storage slimecore:_ v.fetch_requirements.list[-1].url set from storage slimecore:_ v.fetch_requirements.fetched.url.this
data modify storage slimecore:_ v.fetch_requirements.list[-1].order set from storage slimecore:_ v.fetch_requirements.fetched.expected_order
