...
data modify storage slimecore:_ x.mline set value {1:"data modify storage v.pack.this_url set from storage slimecore:in pack.pack.", 2:true}
data modify storage slimecore:_ x.mline.2 set from storage slimecore:_ v.pack.url_paths[-1]
