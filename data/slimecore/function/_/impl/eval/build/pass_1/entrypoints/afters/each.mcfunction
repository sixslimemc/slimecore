...
data modify storage slimecore:_ x set value {1:"data modify storage slimecore:_ v.build.maps.'", 2:true, 3:"'.'", 4:true, 5:"'.'", 6:true, 7:"' append from storage slimecore:_ x.entry"}
data modify storage slimecore:_ x.2 set from storage slimecore:_ v.build.map_key
data modify storage slimecore:_ x.4 set from storage slimecore:_ v.build.this_after.pack_ref
data modify storage slimecore:_ x.6 set from storage slimecore:_ v.build.this_after.id
