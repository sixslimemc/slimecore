...
data modify storage slimecore:_ x set value {1:"data modify storage slimecore:_ v.build.dep_pack set from storage slimecore:_ v.build.maps.packs.'", 2:true, 3:"'"}
data modify storage slimecore:_ x.2 set from storage slimecore:_ v.build.this_dep.pack_id
