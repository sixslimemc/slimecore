...
data modify storage slimecore:_ x set value {1:"data modify storage slimecore:_ v.build.impl_pack set from storage slimecore:_ v.build.maps.impls.'", 2:true, 3:"'.'", 4:true, 5:"'"}
data modify storage slimecore:_ x.2 set from storage slimecore:_ v.build.this_pack.pack_id
data modify storage slimecore:_ x.4 set from storage slimecore:_ v.build.this_abstract
function slimecore:_/util/mline/5 with storage slimecore:_ x
