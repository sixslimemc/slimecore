...
execute if score *x _slimecore matches 0 run data merge storage slimecore:out {pack_id:{error:{invalid_value:{expected:"valid $namespace"}}}}
execute if score *x _slimecore matches -1 run data merge storage slimecore:out {pack_id:{error:{invalid_value:{expected:'valid $namespace (cannot be "minecraft")'}}}}
execute if score *x _slimecore matches -2 run data merge storage slimecore:out {pack_id:{error:{invalid_value:{expected:'valid $namespace (cannot be "slimecore")'}}}}
