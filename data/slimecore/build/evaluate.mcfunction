...
data modify storage slimecore:_ build.in.manifests set from storage slimecore:in evaluate.packs
execute store result score *x _slimecore run function slimecore:_/build/main
data modify storage slimecore:out evaluate.result set from storage slimecore:_ build.out.result
data modify storage slimecore:out evaluate.error set from storage slimecore:_ build.out.error

data remove storage slimecore:in evaluate
